 ...
 * Use the [RestultFragment.newInstance] factory method to
...
class ResultFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        option = arguments?.getInt("index")?:-1 // 셀렉트 프레그먼트에서 넘어오는 index는 널일 수있는데 option변수가 notnull타입이라 널타입인 ?를 써서 에러가난다. 이럴때 엘비스 연산자를 이용해서 디폴트값을 지정해주면 된다.
    ...
    companion object {
         ...
         * @return A new instance of fragment RestultFragment.
         */
